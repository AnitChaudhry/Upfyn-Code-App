...
import asteriskLogo from "@/assets/nfo/upfyn-logo.png";
import keygennMusic from "@/assets/nfo/upfyn-nfo.ogg";
...
export const NFOCredits: React.FC<NFOCreditsProps> = ({ onClose }) => {
  ...
  const creditsContent = [
    { type: "header", text: "Upfyn Code v1.0.0" },
    { type: "subheader", text: "[ BY UPFYN ]" },
    { type: "spacer" },
            ...
            <div className="flex items-center justify-between px-4 py-2 bg-card border-b border-border">
              ...
              <div className="flex items-center space-x-2">
                <Button
                  ...
                  onClick={async (e) => {
                    e.stopPropagation();
                    await openUrl("https://cli.upfyn.com");
                  }}
              ...
              <div className="absolute top-0 left-0 right-0 bg-background z-10 pb-4 text-center">
                ...
                >
                  <img
                    src={asteriskLogo}
                    alt="Upfyn"
                    className="h-20 w-auto mx-auto opacity-90 rounded-lg"
                  />
                </button>
