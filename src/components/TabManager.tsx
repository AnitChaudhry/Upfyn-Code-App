...
import { X, Plus, MessageSquare, Bot, AlertCircle, Loader2, Folder, BarChart, Server, Settings, FileText, Terminal, Code, FolderTree, GitBranch, Layout, Workflow, CheckSquare, Globe } from 'lucide-react';
