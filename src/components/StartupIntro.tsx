      ...
      {visible && (
        ...
        >
          ...
          >
            ...
            {/* App logo slides left; brand text reveals to the right */}
...
function BrandText() {
  return (
    <div className="text-5xl font-extrabold tracking-tight brand-text">
      <span className="brand-text-solid">Upfyn Code</span>
      <span aria-hidden="true" className="brand-text-shimmer">Upfyn Code</span>
    </div>
  );
}
