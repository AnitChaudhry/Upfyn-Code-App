        ...
        <div className="flex-1 overflow-y-auto p-6">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid grid-cols-9 w-full mb-6 h-auto p-1">
              ...
              <TabsTrigger value="ai-providers" className="py-2.5 px-3">AI Providers</TabsTrigger>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-1">
                        ...
                        <p className="text-caption text-muted-foreground">
                          Help improve Upfyn Code by sharing anonymous usage data
                        </p>
                      </div>
                      <Switch
            ...
            <TabsContent value="ai-providers">
              <Card className="p-6">
                <AIProvidersSettings setToast={setToast} />
              </Card>
            </TabsContent>
