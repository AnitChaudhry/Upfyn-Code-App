...
import { Settings, Minus, Square, X, Bot, BarChart3, FileText, Network, Info, MoreVertical, Layout, Terminal, Code, FolderTree, GitBranch, Workflow, CheckSquare, Globe, Sparkles } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center pr-5 gap-3 tauri-no-drag">
        {/* Upfyn feature actions */}
        <div className="flex items-center gap-1">
          {onTerminalClick && (
            <TooltipSimple content="Terminal" side="bottom">
              <motion.button
          ...
          {onEditorClick && (
            <TooltipSimple content="Code Editor" side="bottom">
              <motion.button
          ...
          {onFilesClick && (
            <TooltipSimple content="Files" side="bottom">
              <motion.button
          ...
          {onGitClick && (
            <TooltipSimple content="Git" side="bottom">
              <motion.button
                onClick={onGitClick}
                whileTap={{ scale: 0.97 }}
                transition={{ duration: 0.15 }}
          ...
          {onCanvasClick && (
            <TooltipSimple content="Canvas" side="bottom">
              <motion.button
          ...
          {onBrowserClick && (
            <TooltipSimple content="Browser" side="bottom">
              <motion.button
          ...
          {onBYOKChatClick && (
            <TooltipSimple content="AI Chat (BYOK)" side="bottom">
              <motion.button
                onClick={onBYOKChatClick}
                whileTap={{ scale: 0.97 }}
                transition={{ duration: 0.15 }}
                className="p-2 rounded-md hover:bg-accent hover:text-accent-foreground transition-colors tauri-no-drag"
              >
          ...
          {onTasksClick && (
            <TooltipSimple content="Tasks" side="bottom">
              <motion.button
