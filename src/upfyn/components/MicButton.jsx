    ...
    <div className="relative">
      ...
      {error && (
        <div className="absolute bottom-full mb-2 right-0
                        bg-destructive/90 text-destructive-foreground text-[11px] px-2.5 py-1.5 rounded-lg whitespace-nowrap z-50
                        animate-fade-in shadow-lg max-w-[220px] text-center"
