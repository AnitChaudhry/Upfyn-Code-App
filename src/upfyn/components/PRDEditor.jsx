...
- Approved By: Product Owner, Technical Lead`;
  ...
  const handleSave = async () => {
    if (!content.trim()) {
      addToast('Please add content before saving.', 'warning');
      return;
    }

    if (!fileName.trim()) {
      addToast('Please provide a filename for the PRD.', 'warning');
      return;
    }
  ...
  const performSave = async () => {
    ...
    try {
      ...
      addToast(`Error saving PRD: ${error.message}`, 'error');
    } finally {
      setSaving(false);
    }
  };
  ...
  const handleGenerateTasks = async () => {
    if (!content.trim()) {
      addToast('Please add content to the PRD before generating tasks.', 'warning');
      return;
    }
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md border border-gray-200 dark:border-gray-700">
            ...
            <div className="p-6 space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <h4 className="font-semibold text-purple-900 dark:text-purple-100 mb-2">
                      💡 Pro Tip: Ask Your AI Assistant Directly!
                    </h4>
                    <p className="text-sm text-purple-800 dark:text-purple-200 mb-3">
                      You can simply ask your AI assistant in the chat to parse your PRD and generate tasks. 
              ...
              <div className="pt-4">
                ...
                >
                  Got it, I'll ask my AI assistant directly
                </button>
              </div>
            </div>
          </div>
