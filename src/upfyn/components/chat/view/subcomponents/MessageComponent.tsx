...
const MessageComponent = memo(({ message, index, prevMessage, createDiff, onFileOpen, onShowSettings, onGrantToolPermission, autoExpandTools, showRawParameters, showThinking, selectedProject, provider, onArtifactOpen }: MessageComponentProps) => {
  ...
  return (
    <ArtifactProvider value={onArtifactOpen || null}>
    <div
      ref={messageRef}
        ...
        <div className="w-full">
          ...
          <div className="w-full">
            ...
            {message.isToolUse ? (
              ...
              /* Thinking messages - Claude.ai-style collapsible */
              <div className="text-sm">
                <details className="group rounded-lg border border-purple-500/20 dark:border-purple-400/15 bg-purple-50/30 dark:bg-purple-950/10 overflow-hidden">
                  <summary className="cursor-pointer px-3 py-2 flex items-center gap-2.5 hover:bg-purple-50/50 dark:hover:bg-purple-950/20 transition-colors select-none">
                    <svg className="w-3.5 h-3.5 text-purple-500 dark:text-purple-400 transition-transform group-open:rotate-90 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="px-3 pb-3 pt-1 border-t border-purple-500/10 dark:border-purple-400/10">
                    <div className="pl-3 border-l-2 border-purple-400/30 dark:border-purple-500/20 text-gray-600 dark:text-gray-400 text-sm">
              ...
              <div className="text-sm text-gray-700 dark:text-gray-300">
                {/* Extended thinking - Claude.ai-style reasoning block */}
                {showThinking && message.reasoning && (
                  <details className="mb-3 group/reasoning rounded-lg border border-purple-500/20 dark:border-purple-400/15 bg-purple-50/30 dark:bg-purple-950/10 overflow-hidden">
                    <summary className="cursor-pointer px-3 py-2 flex items-center gap-2.5 hover:bg-purple-50/50 dark:hover:bg-purple-950/20 transition-colors select-none">
                      <svg className="w-3.5 h-3.5 text-purple-500 dark:text-purple-400 transition-transform group-open/reasoning:rotate-90 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                      </svg>
                      <svg className="w-4 h-4 text-purple-500 dark:text-purple-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                      </svg>
                      <span className="text-xs font-medium text-purple-700 dark:text-purple-300">Extended thinking</span>
                    </summary>
                    <div className="px-3 pb-3 pt-1 border-t border-purple-500/10 dark:border-purple-400/10">
                      <div className="pl-3 border-l-2 border-purple-400/30 dark:border-purple-500/20 text-gray-600 dark:text-gray-400 text-sm">
                        <Markdown className="prose prose-sm max-w-none dark:prose-invert prose-gray">
