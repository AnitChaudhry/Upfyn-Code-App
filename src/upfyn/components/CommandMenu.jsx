...
const CommandMenu = ({
  ...
  // Merge all non-builtin groups into a single "project" group
  for (const ns of Object.keys(groupedCommands)) {
    if (ns !== 'builtin' && ns !== 'project' && ns !== 'frequent') {
      groupedCommands.project = [...(groupedCommands.project || []), ...groupedCommands[ns]];
      delete groupedCommands[ns];
    }
  }

  // Order: frequent, builtin (Upfynai), project
  const namespaceOrder = hasFrequentCommands
    ? ['frequent', 'builtin', 'project']
    : ['builtin', 'project'];
                  ...
                  >
                    ...
                    <span
                      ...
                      style={{
                        ...
                        padding: '2px 6px',
                        borderRadius: '4px',
                        backgroundColor: namespace === 'builtin' ? '#dbeafe' : '#f3f4f6',
                        color: namespace === 'builtin' ? '#2563eb' : '#6b7280',
                        fontWeight: 500,
                      }}
                    >
                      {namespace === 'builtin' ? 'Upfynai' : 'Project'}
                    </span>
                  </div>
