...
import { Check, ChevronDown, ChevronRight, Edit3, Folder, FolderOpen, Settings, Star, Trash2, X } from 'lucide-react';
                ...
                {isEditing ? (
                  ...
                  <>
                    ...
                    <button
                      ...
                      title={t('tooltips.projectSettings', { defaultValue: 'Project settings' })}
                    >
