import { Folder, Search, WifiOff } from 'lucide-react';
    ...
    if (!isRelayConnected) {
      return (
        <div className="text-center py-12 md:py-8 px-4">
          ...
          <h3 className="text-base font-medium text-foreground mb-2 md:mb-1">No machine connected</h3>
          <p className="text-sm text-muted-foreground">Connect your machine to see projects</p>
        </div>
      );
    }
    return (
