...
export interface ArtifactPanelProps {
  artifacts: import('../hooks/useArtifactPanel').Artifact[];
  activeArtifactId: string | null;
  panelWidth: number;
  panelExpanded: boolean;
  resizeHandleRef: import('react').RefObject<HTMLDivElement>;
  onResizeStart: (event: import('react').MouseEvent<HTMLDivElement>) => void;
