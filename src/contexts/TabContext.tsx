...
export interface Tab {
  id: string;
  type: 'chat' | 'agent' | 'agents' | 'projects' | 'usage' | 'mcp' | 'settings' | 'claude-md' | 'claude-file' | 'agent-execution' | 'create-agent' | 'import-agent' | 'canvas' | 'terminal' | 'code-editor' | 'file-tree' | 'git' | 'workflows' | 'task-master' | 'browser' | 'byok-chat';
  title: string;
...
// const STORAGE_KEY = 'upfyn_tabs'; // No longer needed - persistence disabled
const MAX_TABS = 20;
